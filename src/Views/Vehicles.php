...
<head>
    ...
    <title style=''>Vehicles | VSHTS</title>
</head>
<body>
<div class='container-fluid px-0'>
    <nav class='navbar navbar-expand-xl navbar-dark bg-primary sticky-top'>
        <a href='./Index.php' class='display-4 navbar-brand ml-2' style='font-size: 1.7em;'>XYZ Widget Emporium</a>
        <div class='float-right text-right'>
            <a class=\"text-light btn btn-primary mx-2 my-sm-0\" href=\"#\">About</a>
            <a class=\"text-light btn btn-primary mr-2 my-sm-0\" href=\"#\">Login</a>
        </div>
    </nav>
